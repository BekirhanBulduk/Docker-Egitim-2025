...
< -t ne anlama gelir = imajı oluştururken ona bir tag isim vermeni sağlar >
...
> “Bu uygulama basit bir Node.js Express uygulamasıdır. Ana sayfa (/) ve kullanıcı listesi (/users) gibi endpoint’leri var. Dockerfile sayesinde uygulama container içinde çalıştırılabiliyor ve her ortamda aynı şekilde çalışıyor olacak.”

# İMAJI REPOYA PUSH EDELİM 
# Login olalım 
docker login 
# Docker Hub’a push etmek için imajı kullanıcı adınla tekrardan tag’le:
